...
7. **Lena's page.** Her avatar at the end of the product bar opens a settings view for the dispatcher and, beside it, the story of the build: project, persona, problems, solutions, why, with the design decks linked where they belong. Each chapter opens with the design file's own slides.
