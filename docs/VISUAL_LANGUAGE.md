...
Completed paths and markers share one semantic progress gradient, moving from dark clear-green at the route origin to soft sage at the most recently completed edge. These same endpoints are reused by the stop-map counterpart.
