...
src/
  ...
  activity/     derive.ts · markers.ts · filters.ts · copy.ts (+ tests: the feed, the markers at 2:47, the filters, the card copy) · ActivityPanel.tsx · ActivityFilters.tsx · ActivityCard.tsx
  views/
