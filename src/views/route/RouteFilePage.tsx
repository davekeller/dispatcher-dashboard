    ...
    <div className="route-workspace flex h-full min-h-0 flex-col">
      ...
      <div className="flex min-h-0 flex-1 items-stretch gap-5 pr-5">
        ...
        <div className="min-w-0 flex-1 overflow-y-auto py-5">
          {/* The column caps at 58rem and centers in the scroll area, so a wide window does not stretch the receipts. */}
          <div className="mx-auto flex w-full max-w-[58rem] flex-col gap-5">
