...
export const LOOKOUT_TONE: Tone = { text: 'text-ink', fill: 'bg-nav-selected-ink', soft: 'bg-lookout-soft', border: 'border-line' }
/** Priority is metadata, not attention: slate, so amber stays reserved for watch. */
export const PRIORITY_TONE: Tone = { text: 'text-nav-selected-ink', fill: 'bg-nav-selected-ink', soft: 'bg-nav-selected', border: 'border-nav-selected-line' }
